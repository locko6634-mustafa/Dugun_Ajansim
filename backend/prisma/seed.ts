...
const services = [
  ['fotograf', 'photo', 'Düğün Fotoğrafçılığı', 700_000, 'assets/images/services/fotograf-cekimi.webp'],
  ['video', 'production', 'Sinematik Düğün Filmi', 900_000, 'assets/images/services/video-cekimi.webp'],
  ['drone', 'production', 'Drone Çekimi', 800_000, 'assets/images/services/drone-cekimi.webp'],
  ['jimmy-jib', 'production', 'Jimmy Jib Çekimi', 1_200_000, 'assets/images/services/klip-cekimi.webp'],
  ['dis-cekim', 'photo', 'Dış Çekim', 700_000, 'assets/images/hero-couple.webp'],
  ['organizasyon', 'experience', 'Organizasyon Hizmetleri', 550_000, 'assets/images/services/360-video.webp'],
  ['album', 'experience', 'Premium Albüm Tasarımı', 700_000, 'assets/images/services/album-tasarimi.webp'],
  ['aninda-baski', 'experience', 'Anında Fotoğraf Baskısı', 500_000, 'assets/images/bride-portrait.webp'],
] as const;
