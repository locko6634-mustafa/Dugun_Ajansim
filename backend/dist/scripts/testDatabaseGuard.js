...
export const assertSafeLocalTestDatabase = (environment = process.env) => {
    ...
    const isExpectedTarget = parsedDatabaseUrl.hostname === EXPECTED_TEST_DATABASE_HOST &&
    ...
    if (environment.NODE_ENV !== 'test' ||
        ...
        !isExpectedTarget) {
        throw new Error('Test veritabanı işlemi yalnızca açık guard ile localhost:55432/dugun_ajansim_test hedefinde çalıştırılabilir.');
    }
